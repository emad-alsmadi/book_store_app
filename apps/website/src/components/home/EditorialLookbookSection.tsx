...
/** DEMO module — TODO(api): GET /api/storefront/lookbooks */
export function EditorialLookbookSection({
  stories = DEMO_LOOKBOOK_STORIES,
}: Props) {
      ...
      <div className='mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8'>
        <div className='mb-8 max-w-2xl'>
          ...
          <p className='mt-2 text-sm text-stone-600'>
            Lifestyle storytelling modules — original TrendVaulta copy and local
            imagery. Swap with CMS lookbooks later.
          </p>
        </div>
